...
```bash
git clone https://github.com/Naveena-kemburu/Build-Multi-Tenant-SaaS-Platform-with-Project-Task-Management/
cd Build-Multi-Tenant-SaaS-Platform-with-Project-Task-Management
docker-compose up -d
```
